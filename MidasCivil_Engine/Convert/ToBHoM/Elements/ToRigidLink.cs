...
namespace BH.Engine.MidasCivil
{
    public static partial class Convert
    {
        public static RigidLink ToRigidLink(string rigidLink, Dictionary<string,Node> nodes, int count)
        {
            ...
            bool x = Engine.MidasCivil.Convert.FromFixity(fixity.Substring(0, 1));
            bool y = Engine.MidasCivil.Convert.FromFixity(fixity.Substring(1, 1));
            bool z = Engine.MidasCivil.Convert.FromFixity(fixity.Substring(2, 1));
            bool xx = Engine.MidasCivil.Convert.FromFixity(fixity.Substring(3, 1));
            bool yy = Engine.MidasCivil.Convert.FromFixity(fixity.Substring(4, 1));
            bool zz = Engine.MidasCivil.Convert.FromFixity(fixity.Substring(5, 1));
