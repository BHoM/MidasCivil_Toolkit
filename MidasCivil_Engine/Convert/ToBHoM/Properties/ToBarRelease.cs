...
namespace BH.Engine.MidasCivil
{
    public static partial class Convert
    {
        public static BarRelease ToBarRelease(string release, int count)
        {
            ...
            for (int i=0; i<6; i++)
            {
                bhomStartFixity.Add(Engine.MidasCivil.Compute.FromFixity(startFixity.Substring(i, 1)));
                bhomEndFixity.Add(Engine.MidasCivil.Compute.FromFixity(endFixity.Substring(i, 1)));
            }
