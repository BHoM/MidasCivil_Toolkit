    ...
    public partial class MidasCivilAdapter
    {
        public bool CreateCollection(IEnumerable<PointLoad> pointLoads)
        {
            ...
            foreach (PointLoad PointLoad in pointLoads)
            {
                ...
                string midasLoadGroup = Engine.MidasCivil.Convert.FromLoadGroup(PointLoad);
                ...
                {
                   midasPointLoads.Add(Engine.MidasCivil.Convert.FromPointLoad(PointLoad, assignedNode));
                }
