                ...
                if (barPointLoads.Count != 0)
                {
                    ...
                    if (barComparison.Count != 0)
                    {
                        ...
                        foreach (string distinctBarLoad in distinctBarLoads)
                        {
                            ...
                            BarPointLoad bhomBarPointLoad = Adapter.External.MidasCivil.Convert.ToBarPointLoad(distinctBarLoad, matchingBars, loadcase, loadcaseDictionary, barDictionary, j);
